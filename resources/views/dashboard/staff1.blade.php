<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            {{-- Ready for Processing Alert --}}
            @if(($dashboardStats['staff2_approved'] ?? 0) > 0)
                <div class="bg-gradient-to-r from-teal-50 to-emerald-50 border border-teal-200 rounded-2xl p-6 shadow-lg">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-teal-900 mb-1">Ready for Manual Processing</h3>
                            <p class="text-teal-700 text-sm">{{ $dashboardStats['staff2_approved'] }} request(s) have been approved by Staff 2 and are ready for printing / manual processing. Mark them as Completed once done.</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            @php
                $myQueue = ($dashboardStats['submitted'] ?? 0) + ($dashboardStats['staff2_approved'] ?? 0);
            @endphp
                    ...
                    <div class="mb-6 md:mb-0">
                        ...
                        <div class="mt-4 flex flex-wrap gap-4">
                            ...
                            <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                                ...
                                <div class="text-sm text-orange-100">Sent to Staff 2</div>
                            </div>
                            <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="mt-1 text-3xl font-bold text-orange-900">{{ $dashboardStats['staff1_reviewed'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
